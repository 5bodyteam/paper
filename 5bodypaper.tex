...
\begin{figure}
\includegraphics[width=6in, height=2in]{t1rG0region.png}
 \caption{ \label{EL}  Conditions for central configuration  when $\frac{M}{\lambda}$ for specified regions for $r$ and $s$ in the $t=1$ plane. Notation is simplified in the figure. For example, 1 represents $-\frac{F_1}{G_1}$.}
\end{figure}
